"""
Django settings for ArxivAppBackend project.
...
CSRF_COOKIE_NAME = 'arxivapp_csrftoken'
SESSION_COOKIE_NAME = 'arxivapp_sessionid'
...
WSGI_APPLICATION = 'ArxivAppBackend.wsgi.application'
